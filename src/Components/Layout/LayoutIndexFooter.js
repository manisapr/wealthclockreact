                            ...
                            <div className="col-sm-3 col-xs-6">
                                <div className="ftr-inn xtra">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/Components/HowItWorks">- How It Works</a>
                                        </li>
                                        <li>
                                            <a href="/Components/WhyUs">- Why Us</a>
                                        </li>
                                        <li>
                            ...
                            <div className="col-sm-3 col-xs-6">
                                <div className="ftr-inn xtra-rght">
                                    ...
                                    <div className="ftr-add">
                                        <span><i className="fa fa-map-marker" aria-hidden="true"></i></span>
                                        <p>
                                            Plot no. 146, 19/7, <br /> Sahapur Colony, Bankim Mukherjee Sarani, <br />Block J ,<br />Kolkata, West Bengal - 700053

                                </p>
                                    </div>
                                    <div className="ftr-add">
                                        <span><i className="fa fa-phone" aria-hidden="true"></i></span>
                                        <a href="tel:+919903866366"> +91 99038 66366 </a>
                                    </div>
                                    <div className="ftr-add">
                                        <span><i className="fa fa-paper-plane" aria-hidden="true"></i></span>
                                        <a href="mailto:contact@wealthclockadvisors.com "> contact@wealthclockadvisors.com </a>
...
export default LayoutIndexFooter;
