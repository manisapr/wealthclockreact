                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-3 col-xs-6">
                                <div className="ftr-inn xtra">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="http://localhost:3000/Components/About">- About Us</a>
                                        </li>
                                        <li>
                                            <a href="http://localhost:3000/AboutUs/HowItWorks">- How It Works</a>
                                        </li>
                                        <li>
                                            <a href="http://localhost:3000/AboutUs/WhyUs">- Why Us</a>
                                        </li>
                                        <li>
                                            <a href="/solution/index">- Solution</a>

                                        </li>
                                        <li>
                                            <a href="/wealthclockpicks/index">- WealthClockPicks</a>
                                        ...
                                        <li>
                                            <a href="/DownloadForm/index">- Download Form</a>

                                        </li>
                                        <li>
                                            <a href="/DownloadForm/Ebook">- Download Ebook</a>
                            ...
                            <div className="col-sm-3 col-xs-6">
                                <div className="ftr-inn xtra-rght">
                                    ...
                                    <div className="ftr-add">
                                        ...
                                        <p>
                                            Wealthclock Advisors, <br />205, Regal Diamond Center <br />Opera House, <br />Mumbai,Maharashtra 400004
                                    ...
                                    <div className="ftr-add">
                                        ...
                                        <a href="mailto:contact@wealthclockadvisors.com "> contact@wealthclockadvisors.com </a>
                                    </div>
                            ...
                            <div className="col-sm-2 col-xs-6">
                                <div className="ftr-inn">
                                    ...
                                    <a href="https://www.pinterest.com/wealthclockadvisor/" className="social">
                                        <i className="fa fa-pinterest-p" aria-hidden="true"></i>
                                        <p>Pinterest</p>
                                    </a>

                                    <a href="https://www.youtube.com/channel/UCoUK3b303NIYAAqNM4jSWoQ" className="social">
                        ...
                        <div className="certify-cell">
                            <div className="certify-image">
                                <a href="https://www.amfiindia.com/" target="_blank" className="certify-image">
                                    <img src="/images/AMFI-Logo.png" alt="" width="60" />
                                </a>
                            </div>
                            <p>
                        ...
                        <div className="certify-cell">
                            <div className="certify-image">
                                <a href="https://www.bseindia.com/" target="_blank" className="certify-image">
                                    <img src="/images/Bombay_Stock_Exchange_logo.png" alt="" width="100" />
                                </a>
                            </div>
                            <p>
            ...
            <footer>
                <div className="container">
                    ...
                    <div className="ftr-copy">
                        <p>2019 Copyright &copy; <a href="~/Home/Index">WealthClock</a>. All rights reserved.</p>
                        <ul>
                            <li>
...
export default LayoutAboutFooter;
