(function($) {
    $.fn.accordion = function(options) {
        return this.each(function() {
            ...
            $(this).children(".prt-hdr").each(function() {
                $(this).next('div').andSelf().wrapAll("<div class='accordion-item'></div>");
            });
            $(this).children().children('div').addClass("accordion-content");
            $(this).find(".prt-hdr").wrap("<div class='accordion-header clearfix'></div>");
            $(this).find(".prt-hdr").after("<div class='accordion-header-icon'>" + settings.dropDownIcon + "</div>");
